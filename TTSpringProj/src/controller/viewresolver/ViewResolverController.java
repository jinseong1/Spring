...
public class ViewResolverController {
	...
	public ModelAndView execute(Model model) throws Exception{
		...
		//반환타입이 String인 경우]
		//1]forward:로 리턴시]
		//return "forward:/ViewResolver04/ViewResolver.jsp";
		//2]redirect:로 리턴시
		//return "redirect:/ViewResolver04/ViewResolver.jsp";
		//반환타입이 ModelAndView인 경우]
		//-뷰정보를 View객체나 스트링인 경우는 
		// forward:나 redirect: 이 붙은 String으로
		
		//뷰정보를 String으로 반환 [x]-접두어,접미어가 붙음
		//return new ModelAndView("/ViewResolver04/ViewResolver.jsp");
		//뷰정보 String이나 forward:[o]
		//return new ModelAndView("forward:/ViewResolver04/ViewResolver.jsp");
		//뷰정보 String이나 redirect:[o]
		//return new ModelAndView("redirect:/ViewResolver04/ViewResolver.jsp");
		//뷰정보로 View객체:[o]
		return new ModelAndView(new InternalResourceView("/ViewResolver04/ViewResolver.jsp"));
	}///////////////
}
