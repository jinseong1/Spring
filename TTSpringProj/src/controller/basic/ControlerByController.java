...
//컨트롤러 클래스]
public class ControlerByController implements Controller {

	//[생성자]
	public ControlerByController() {
		System.out.println("ControlerByController:생성자");
	}
	...
	public ModelAndView handleRequest(HttpServletRequest req, HttpServletResponse resp) throws Exception {
		...
		//5]DispatcherServlet에게 ModelAndView객체 반환
		return mav;
	}
