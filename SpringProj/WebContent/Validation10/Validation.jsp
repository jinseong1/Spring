...
<body>
      ...
      <table bgcolor="gray" cellspacing="1" width="60%" >
       ...
       <tr bgcolor="white">
        ...
        <input type="radio" name="gender" value="남자" <c:if test="${param.gender=='남자' }">checked</c:if> />남자
       ...
       <tr bgcolor="white">
        ...
        <input  type="checkbox" name="inters" value="정치" <c:if test="${fn:indexOf(inters,'정') != -1 }">checked</c:if> />정치
        <input  type="checkbox" name="inters" value="경제" <c:if test="${fn:indexOf(inters,'경') != -1 }">checked</c:if>/>경제
        <input  type="checkbox" name="inters" value="스포츠" <c:if test="${fn:indexOf(inters,'스') != -1 }">checked</c:if> />스포츠
