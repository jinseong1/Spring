...
public class PersonApp {
	...
	public static void main(String[] args) {
		...
		student2.study();
		System.out.println("[기본 생성자로 객체 생성:Teacher]");
		/*인자 생성자를 정의해서 더이상 기본생성자를
		제공해주지 않음으로...
		기본 생성자로 객체 생성하려면
		기본 생성자를 직접 정의해주어야 한다.*/
		//Teacher teahcer = new Teacher();//[x]
		Teacher teahcer = new Teacher("박길동", 40,"인천","자바");
		teahcer.printTeacher();
		teahcer.teach();
	}/////////////main
