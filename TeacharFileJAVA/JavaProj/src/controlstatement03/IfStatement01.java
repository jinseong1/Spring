...
public class IfStatement01 {
	...
	public static void main(String[] args) throws IOException {
		...
		*/
		...
		if(num1 % 2 ==0) {
			System.out.printf("%d은 짝수다%n",num1);
		}		
		if(num1 % 2 !=0) {
			System.out.printf("%d은 홀수다%n",num1);
		}
		if(num1 % 2==0 && num1 >=10) {
	   ...
	   //방법1]하나의 조건식안에서 논리 연산으로 처리
	     boolean isMultiple = word >='0' && word <='9' && (word-'0') % 2 ==0;
	     if(isMultiple) System.out.println("2의 배수입니다");
	     isMultiple = word >='0' && word <='9' && (word-'0') % 2 !=0;
