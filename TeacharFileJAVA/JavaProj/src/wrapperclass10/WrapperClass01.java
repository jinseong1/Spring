...
public class WrapperClass01 {
	...
	public static void main(String[] args) {
		...
		System.out.println("num1Obj="+num1Obj);
		System.out.println("num1Obj="+num1Obj.toString());
		...
		Integer num3Obj =300;//오토 박싱(int형상수(300)->Integer)
		/*
		Wrapper클래스를 사용하는 이점:
		...
		*/
		...
		System.out.println(num1Obj.getClass().getName());
		 ...
		 */
		Integer remodel = new Integer(99);//99
		System.out.println("remodel="+remodel);//toString()이 생략된거와 같다
